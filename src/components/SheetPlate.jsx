...
function SheetPlate() {
  ...
  return (
    <div className="min-h-screen w-full m-auto">
      ...
      {/* Main Content */}
      <div className="flex flex-col lg:flex-row gap-8 w-[90%] md:w-[84%] m-auto mt-10 mb-10">
        {/* Left Content */}
        <div className="w-full lg:w-[70%]">
          <div className="w-full h-auto md:h-[600px]">
            <img
              className="w-full h-full object-cover"
              src="https://www.pasteel.com/wp-content/uploads/2022/02/Sheet-Metal-stacked-scaled.jpg"
              alt="sheetplate"
            />
          </div>

          <div className="text-justify leading-relaxed text-base md:text-lg text-gray-800 mt-6">
            {/* Main Heading */}
            ...
            <p className="mb-6">
              ...
              , we are dedicated to providing a wide range of high-quality
              flanges, including SORF, slip-on, blind, BLRF, weld neck, WNRF,
              and socket weld flanges, made from premium materials such as{" "}
              <span className="text-[#e0bc74] font-medium">
                Stainless Steel, Inconel, Monel, Nickel, Hastelloy, and Duplex
              </span>
              . Our inventory ensures durability, corrosion resistance, and
              superior performance.
            </p>

            {/* Stainless Steel Flanges */}
            <h3 className="text-2xl font-bold text-[#464A4D] mt-8 mb-3">
              1. Stainless Steel Flanges
            </h3>
            <p className="mb-3">
              Available in grades 304, 316, 321, and 410. Options include
              slip-on, weld neck, and blind flanges. Known for strength,
            ...
            <ul className="list-disc ml-8 space-y-1 text-gray-700">
              ...
              <li>
                <span className="font-semibold text-[#e0bc74]">Durability:</span>{" "}
                High tensile strength for reliable sealing.
              </li>
              <li>
                <span className="font-semibold text-[#e0bc74]">Versatility:</span>{" "}
                Performs under varied temperatures and pressures.
              </li>
            </ul>
            ...
            <p className="mb-3">
              Designed for extreme environments with excellent oxidation and
              corrosion resistance. Common in aerospace, oil & gas, and chemical
              industries.
            </p>
            <ul className="list-disc ml-8 space-y-1 text-gray-700">
              <li>
              ...
              <li>
                ...
                High tensile reliability under stress.
              </li>
            </ul>
            ...
            <p className="mb-3">
              Nickel-copper alloy (Monel 400, K-500). Ideal for marine and
              chemical environments. Includes slip-on, weld neck, and blind
              flanges.
            </p>
            <ul className="list-disc ml-8 space-y-1 text-gray-700">
            ...
            <p className="mb-3">
              Known for outstanding corrosion resistance and high-temperature
              strength. Widely used in aerospace, marine, and chemical
              processing.
            </p>
            <ul className="list-disc ml-8 space-y-1 text-gray-700">
            ...
            <p className="mb-3">
              Designed to withstand severe corrosion, pitting, and stress
              cracking. Used in chemical plants, aerospace, and pollution
              control.
            </p>
            ...
            <p className="mb-3">
              Combine strength of ferritic and corrosion resistance of
              austenitic steels (Duplex 2205, Super Duplex 2507). Perfect for
              oil & gas, marine, and chemical industries.
            </p>
            ...
            <p className="mb-3">
              Lightweight, strong, and highly corrosion resistant. Available in
              slip-on, blind, and threaded types. Trusted in oil & gas and
              chemical industries.
            </p>
            ...
            <p>
              ...
              , we provide premium-quality flanges across Stainless Steel,
              Inconel, Monel, Nickel, Hastelloy, Duplex, and Titanium. Explore
              our full range to find the perfect solution for your business
              needs.{" "}
              <span className="text-[#e0bc74] font-semibold">
                Trust NemrexIndustries for quality and service excellence.
              </span>
            </p>
          </div>
        </div>
